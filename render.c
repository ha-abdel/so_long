...
/*   Updated: 2025/01/26 11:29:21 by abdel-ha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	draw_tile(t_data *data, char **test_map, int x, int y)
{
	if (x == 0 && y == 0)
		draw_moves(data, x * 100, y * 100);
	else if (x == data->info->px && y == data->info->py)
		draw_player(data, x * 100, y * 100);
	else if (x == data->info->ex && y == data->info->ey && x != 0 && y != 0)
